        ...
        <div class="border-1 shadow-lg shadow-gray-700 rounded-lg">
            ...
            <div class="flex rounded-t-lg bg-top-color sm:px-2 w-full">
                ...
                <div class="w-2/3 sm:text-center pl-5 mt-10 text-start">
                    ...
                    <p class="text-heading">{content.position}</p>
                </div>
                        ...
                        <div class="py-3 sm:order-none order-3">
                            ...
                            <div>
                                <div class="flex items-center my-1">
                                    ...
                                    <div class="ml-2 truncate">{content.email}</div>
                                </div>
                                <div class="flex items-center my-1">
                        ...
                        <div class="py-3 sm:order-none order-2">
                            ...
                            <div>
                                <div class="flex items-center my-1">
                                    ...
                                    <div class="ml-2">{content.skill1}</div>
                                </div>
                                <div class="flex items-center my-1">
                                    <a class="w-6 text-gray-700 hover:text-orange-600"
                                        aria-label="Visit TrendyMinds YouTube" href="" target="_blank"><svg
            ...
            C435.391,473.741,421.951,478.349,409.378,482.706z">
                                    ...
                                    <div class="ml-2">{content.skill2}</div>
                                </div>
                                <div class="flex items-center my-1">
                                    <a class="w-6 text-gray-700 hover:text-orange-600"
                                    ...
                                    <div class="ml-2">{content.skill3}</div>
                                </div>
                                <div class="flex items-center my-1">
                                    <a class="w-6 text-gray-700 hover:text-orange-600"
                                    ...
                                    <div class="ml-2">{content.skill4}</div>
                                </div>
                        ...
                        <div class="py-3 sm:order-none order-1">
                            ...
                            <div class="flex flex-col space-y-1">
                                ...
                                <div class="flex flex-col">
                                    <p class="font-semibold text-xs text-gray-700">{content.education_year1}</p>
                                    <p class="text-sm font-medium">
                                        <span class="text-green-700">{content.eduaction_institute1}</span>, {content.eduaction_address1}
                                    </p>
                                    <p class="font-bold text-xs text-gray-700 mb-2">{content.eduaction_grade1}</p>
                                </div>
                                <div class="flex flex-col">
                                    <p class="font-semibold text-xs text-gray-700">{content.education_year2}</p>
                                    <p class="text-sm font-medium"><span class="text-green-700">{content.eduaction_institute2}</span>, {content.eduaction_address2}</p>
                                    <p class="font-bold text-xs text-gray-700 mb-2">{content.eduaction_grade2}</p>
                                </div>
                                <div class="flex flex-col">
                                    <p class="font-semibold text-xs text-gray-700">{content.education_year3}</p>
                                    <p class="text-sm font-medium"><span class="text-green-700">SSC</span>, {content.eduaction_address3}</p>
                                    <p class="font-bold text-xs text-gray-700 mb-2">{content.eduaction_grade3}</p>
                                </div>
                    ...
                    <div class="flex flex-col sm:w-2/3 order-first sm:order-none sm:-mt-10">
                        ...
                        <div class="py-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex flex-col">
                                    <p class="text-lg font-bold text-gray-700">{content.experience1}</p>
                                    <p class="font-semibold text-sm text-gray-700">{content.experience_year1}</p>
                                    <p class="font-semibold text-sm text-gray-700 mt-2 mb-1">Key Responsibilities</p>
                                    <ul class="text-sm list-disc pl-4 space-y-1">
                                        <li>{content.experience_responsibilty1}</li>
                                        <li>{content.experience_responsibilty2}</li>
                                        <li>{content.experience_responsibilty3}</li>
                                    </ul>
                                </div>
    
                                <div class="flex flex-col mt-8">
                                    <p class="text-lg font-bold text-gray-700">{content.experience2}</p>
                                    <p class="font-semibold text-sm text-gray-700">{content.experience_year2}</p>
                                    <p class="font-semibold text-sm text-gray-700 mt-2 mb-1">Key Responsibilities</p>
                                    <ul class="text-sm list-disc pl-4 space-y-1">
                                        <li>{content.experience_responsibilty1}</li>
                                        <li>{content.experience_responsibilty2}</li>
                        ...
                        <div class="py-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex flex-col">
                                    <p class="text-lg font-semibold text-gray-700">{content.project1}</p>
                                    <p class="font-normal text-sm text-gray-700 mb-1 pl-2">{content.project_description1}</p>
                                </div>
                                <div class="flex flex-col">
                                    <p class="text-lg font-semibold text-gray-700">{content.project2}</p>
                                    <p class="font-normal text-sm text-gray-700 mb-1 pl-2">{content.project_description2}
                                    </p>
                                </div>
